...
import 'package:ai_life_os/presentation/widgets/add_habit_sheet.dart';
            ...
            if (habits.isEmpty)
              ...
              ...habits.asMap().entries.map((entry) {
                ...
                return Dismissible(
                  ...
                  onDismissed: (_) =>
                      ref.read(habitsProvider.notifier).delete(index),
                  child: Column(
                    children: [
                      GestureDetector(
                        onTap: () =>
                            ref.read(habitsProvider.notifier).increment(index),
                        child: Padding(
